<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AgregarCategoria.aspx.cs" Inherits="tp_cuatrimestral_moreno_murias.AgregarCategoria" %>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="confirmacionAgregar2">Su categoría ha sido agregada con éxito! </h5>
        ...
        <script type="text/javascript">
            function openModalAgregar() {
                ...
                $('#confirmacionAgregar').on('hidden.bs.modal', function () {
                    window.location.href = "AgregarCategoria.aspx"
                })
            }
        </script>
