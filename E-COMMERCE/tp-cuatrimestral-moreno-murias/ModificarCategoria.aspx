<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ModificarCategoria.aspx.cs" Inherits="tp_cuatrimestral_moreno_murias.ModificarCategoria" EnableEventValidation="false" %>
...
<head runat="server">
    ...
    <title>Modificar / Eliminar Categoria</title>
</head>
<body>
            ...
            <div class="row mt-4">
                <div class="col-12">
                    ...
                    <div>
                        ...
                        <h3>Modificar / Eliminar Categoria</h3>
                    </div>
                    <hr />
                        ...
                        <div class="card-header py-3">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    ...
                                    <asp:Label runat="server" ID="lblSinProductos" Visible="false">No se encontraron categorías.</asp:Label>
                                    ...
                                    <div class="modal fade" id="confirmacionModificacion" tabindex="-1" role="dialog" aria-labelledby="confirmacionModificacion2" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="confirmacionModificacion2">Su categoría ha sido modificada con éxito! </h5>
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                        <span aria-hidden="true">&times;</span>
                                                    </button>
                                                </div>
                                    ...
                                    <div class="modal fade" id="confirmacionEliminacionOK" tabindex="-1" role="dialog" aria-labelledby="confirmacionEliminacionOK2" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="confirmacionEliminacionOK2">Su categoría ha sido eliminada con éxito! </h5>
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                        <span aria-hidden="true">&times;</span>
                                                    </button>
                                                </div>
        ...
        <script type="text/javascript">
            function openModal2() {
                ...
                $('#confirmacionModificacion').on('hidden.bs.modal', function () {
                    window.location.href = "ModificarCategoria.aspx"
                })
